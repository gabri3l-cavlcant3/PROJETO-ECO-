O Projeto e-co@ é uma plataforma para a conexão entre coletivos de economia solidária.

A implementação é baseada na versão 6.6 do Open Source Social Network.

Foram feitas customizações nesta instalação, bem como a criaçao de um novo estilo para o projeto
